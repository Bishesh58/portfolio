...
function ProjectCard({ p, i, theme }: { p: Project; i: number; theme: Theme }) {
  ...
  return (
    <div
      className="project-card sticky overflow-hidden"
    ...
    >
      ...
      >
        ...
        />
        <div className="relative grid gap-8 md:grid-cols-[1fr_1.4fr] md:gap-14">
          <div>
            <span className="font-mono text-sm" style={{ color: s.index }}>
              /{p.index}
            </span>
            <h3 className="mt-4 font-display text-3xl leading-[1.02] font-bold tracking-[0.04em] uppercase md:text-5xl">
              {p.title}
            </h3>
