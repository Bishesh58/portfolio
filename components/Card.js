function Card({title, img, code, demo}) {
  return (
    <div className="flex flex-col m-2 h-96 w-96 rounded-2xl border border-gray-300 p-4 hover:shadow-lg hover:shadow-red-200">
